          ...
          <>
            <p className="text-center text-2xl mt-10">
              <span className="font-bold text-red-700 text-3xl uppercase">
                Tu URL es: 
              </span> <a href={`${process.env.frontendURL}/enlaces/${url}`}>{`${process.env.frontendURL}/enlaces/${url}`}</a>
            </p>
            <button
              type="button"
            ...
            <div className="lg:flex md:shadow-lg p-5 bg-white rounded-lg py-10">
              ...
              <div className="md:flex-1 mb-3 mx-2 mt-16 lg:mt-0">
                ...
                <p className="text-lg leading-loose">
                  ...
                  después de ser descargado. Asi puedes mantener lo que compartes en privado y asegurarte de que 
